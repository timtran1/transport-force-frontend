    ...
    return (
        <main className={`max-w-screen-xl m-auto my-[50px] px-[12px] sm:px-[24px]`}>
            <div className={`flex w-full justify-between gap-2`}>
                <h1 className={`text-[36px] font-[700] text-2xl text-pr`}>{t("Pallets")}</h1>
                <Link to={`/pallets/create`}>
                    <Button className={`shadow bg-primary-main text-primary-contrastText`} color={`primary`}>
                        ...
                        className={`hidden sm:inline`}>{t("Create Pallet")}</span>
                    </Button>
                </Link>
            </div>
                        ...
                        <Table.Tbody>{
                            items?.map(item => (
                                <Table.Tr
                                    ...
                                    onClick={() => navigate(`/pallets/${item.id}`)} className={`cursor-pointer`}
                                >
